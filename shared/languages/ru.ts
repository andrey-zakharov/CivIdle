export const RU = {
   ...
   AccountRankUp: "Улучшить ранг аккаунта",
   AccountRankUpDesc: "Весь твой прогресс перенесётся на твой новый ранг",
   AccountRankUpTip: "Поздравляем, твоему аккаунту может быть повышен ранг - нажмите здесь для улучшения!",
